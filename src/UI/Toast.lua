...
local Toast = getgenv().SnowUI.Toast
...
function Toast.Show(title, message, duration)
    ...
    stroke.Color = Color3.fromRGB(100, 130, 255); stroke.Thickness = 1; stroke.Transparency = 0.5; stroke.Parent = frame
    ...
    task.delay(duration, function()
        local t = TweenService:Create(frame, TweenInfo.new(0.3, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {
            Position = UDim2.new(0.5, -130, 1, 20), BackgroundTransparency = 1,
        })
